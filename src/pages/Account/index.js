                ...
                <>
                    ...
                    <View style={{
                        ...
                        <View style={{ padding: 10, }}>
                            ...
                            <MyList label="Alamat NIK" value={user.nik_alamat} />
                            <MyList label="Alamat Domisili" value={user.alamat} />
                            <MyList label="Alamat" value={user.alamat} />
                            <MyList label="Nomor Ponsel" value={user.telepon} />
                            <MyList label="Kecamatan / Puskesmas" value={user.kecamatan} />
                    ...
                    <View style={{
                        ...
                        <MyButton onPress={btnKeluar} warna={colors.primary} title="Keluar" Icons="log-out-outline" />
                    </View>
                </>
            }
        </SafeAreaView >
